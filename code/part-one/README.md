...
_signature, the message, and the public key_ are then all distributed together.
...
able to _confirm that the public key and signature came from the same private key and that the message was not altered_. Not even a single byte. This
